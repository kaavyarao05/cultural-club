...
const page = () => {
  return (
    <div className='bg-black top-0 z-10 min-w-full'>
      ...
      <Image alt="Shine symbol outline" src={Shine} width={65} className='-hue-rotate-60 absolute mr-10 invert sm:right-[13%] -right-[1%] hover:scale-110 hover:rotate-45 translate-y-28'></Image>
