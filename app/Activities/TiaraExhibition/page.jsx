  ...
  return (
    <div className='bg-black top-0 z-10 min-w-full'>
      ...
      <div className="text-center px-5 py-40">
        <h1 className=" text-wheat font-serif text-[40px] font-bold">Tiara Exhibition</h1>
        <h6 className="text-mustard -m-2 font-semibold font-mono">9 May 2024 - 11 May 2024</h6>
      </div>
    </div>
        <div className="grid gap-y-5 mx-10 pb-12 py-5 m-auto justify-center">
        <Polaroid className={"left-polaroid"} alt="Teachers Day" src={Img1} width={640} height={427}></Polaroid>
        </div>
    </div>
