...
const page = () => {
  return (
    <div className='bg-black top-0 absolute z-10 min-w-full'>
      ...
      <Image src={Shine} width={65} className='-hue-rotate-60 absolute mr-10 invert sm:right-[13%] -right-[1%] hover:scale-110 hover:rotate-45 transition:all translate-y-28'></Image>
      <Image src={ShineFill} width={26} className='-hue-rotate-60 absolute mr-10 invert sm:right-[10%] -right-[2%] hover:rotate-45 transition:all  translate-y-28'></Image>
      ...
      <div className="text-center px-5 py-40">
        <h1 className="hover:scale-105 transition-all text-wheat font-serif text-[40px] font-bold">Sourabha</h1>
        <h6 className="text-mustard -m-2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] font-semibold font-mono">Kannada Club</h6>
      </div>
    </div>
      ...
      <Image src={ArrowDown} width={200} className="invert absolute -my-36 -scale-x-100 brightness-50 right-[10px] sm:visible"></Image>
      ...
      <h4 className='italic pt-20 sm:pt-10 text-center mb-5'>The Student Coordinators</h4>
        <div className='grid pt-5 sm:grid-cols-2 grid-rows-2 pb-5 gap-5 sm:gap-8 mx-[22%]'>
          <Council name="Kruthika K R" title="AIML"/>
